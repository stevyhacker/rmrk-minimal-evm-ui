...
export const RMRKFactoryContractAddress = '0x8b30c61B462a05C6a6ef04971956EdD4711264Dc';
...
export const rmrkFactoryContract = {
  addressOrName: RMRKFactoryContractAddress,
  contractInterface: abis.rmrkFactoryAbi
}